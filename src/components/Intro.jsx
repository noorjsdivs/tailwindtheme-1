  ...
  return (
    <>
      ...
      <p className="mt-4 text-sm/6 text-gray-300">
        ...
        voluptatibus odit quibusdam ratione, quas animi corporis voluptatum
        dolorem voluptates ea hic tempore velit cupiditate fugit natus molestias
        possimus consequuntur eum illo adipisci ducimus porro? Enim!
      </p>
      <SignUpForm />
